...
/* ######################################### */
	...
	*/
	...
	function btnHijo(element, id, tipo = '', pos = '', estado, guiacod, compr){
		if ( $("#"+element+" .btn-hijo").is(':visible') ){
			$(".btn-hijo").hide('fast');
		}
		else{
    	...
    	if (tipo == 'oc'){
				...
				// 					 '	<button type="button" class="btn2 btn-default" onclick="ocompra_download_excel('+id+');">' +
	          	...
	          	// 		 '</li>';
				btnHTML += '<li>' +
					     '	<a href="javascript:;" class="btn2 btn-default" onclick="pedido_pdf('+id+',1)"  target="_parent">'+
				  		 '	<img src="'+ base_url +'images/pdf.png" width="16" height="16" border="0" title="Ver PDF">' +
				 		 '	</a>' +
				 		 '</li>';
				if(guiacod == 0 && compr == 0 && estado !=3){
					btnHTML += '<li>' +
							'	<a href="javascript:;" class="btn2 btn-default" onclick="editar_pedido('+id+')">' +
							'	<img src="'+ base_url +'images/modificar.png" width="16" height="16" border="0" title="Ver PDF">' +
							'	</a>' +
							'</li>';
				}
				...
				btnHTML += '<li>' +
						 '	<a href="javascript:;" class="btn2 btn-default" onclick="anular_pedido('+estado+','+id+')"  target="_parent">'+
					     '	<img src="'+ base_url +'images/delete.png" width="16" height="16" border="0" title="Ver PDF">' +
					     '	</a>' +
					     '</li>';
				}
				// Canjes
				btnHTML += '<ul class="btn-hijoInfo">';
					...
					btnHTML += '<li>' +
							...
							'</li>';
					// btnHTML += '<li>' +
					// 		'	<button type="button" class="btn2 btn-success" onclick="canjeToGuiaMultiple('+id+','+pos+')">' +
					// 		'		Generar Guia de Remisión Múltiple' +
					// 		'	</button>' +
					// 		'</li>';
