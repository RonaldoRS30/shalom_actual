...
jQuery(document).ready(function(){
  ...
  // Dev: RC -> Begin - index
    ...
    $("#AceptarConsolidado").click(function(){
        var sucursal = $("#compania").val();
        var codigoProv   = $("#proveedor").val();
        if(codigoProv == ""){
            Swal.fire({
                icon: "warning",
        ...
        url = base_url + "index.php/compras/ocompra/ocompra_pedido/"+codigoProv+"/"+tipo_oper+"/"+sucursal+CodProd+Cantidad;
        location.href = url;
    });
...
$(function () {
    ...
    $("#nombre_proveedor_pedido").autocomplete({
        source: function (request, response) {
            $.ajax({
                url: base_url+"index.php/compras/proveedor/autocomplete/",
                type: "POST",
                data: { term: $("#nombre_proveedor_pedido").val() },
                dataType: "json",
                success: function (data) {
                    response(data);
                }
        ...
        select: function (event, ui) {
            ...
            $("#nombre_proveedor_pedido").val(ui.item.nombre);
