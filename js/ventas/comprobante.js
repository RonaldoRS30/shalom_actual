...
jQuery(document).ready(function () {
    ...
    /*INTEGRACIÓN NUEVA 2024 - NOV - PARA PAGOS MULTIPLES*/
    ...
    $("#grabarComprobante").click(function () {
        ...
        //if ( $("#VerificadoSuccess").val() == "1" ){
            ...
            $("#grabarComprobante").css('visibility', 'hidden'); // SE HABILITO ESTE JQ
    ...
    // AGREGACIÓN DE CAJA 2024 - NOV - PARA LA CAJA
    ...
    // AGREGACIÓN DE FORMA PAGO MULTIPLE - NOV - 2024 - PROG. SERGIO
            ...
            if (tipo_oper == 'V') {
                ...
                // AGREGACIÓN DE CAJA - NOV 2024- PROG. SERGIO
                ...
                // FORMA DE PAGO OBLIGATORIO - NOV 2024 - PROGR. SERGIO
                ...
                // FINALIZA AQUI FORMA DE PAGO OBLIGATORIO
...
function obtener_detalle_ocompra(ocompra) {
    ...
    var isAdelanto = $("#forma_pago").val() == 22;
