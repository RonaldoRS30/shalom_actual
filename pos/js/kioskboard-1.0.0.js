...
var kioskBoardDefaultOptions = {
    ...
    language: 'en',
    theme: 'dark', // "light" || "dark" || "flat" || "material" || "oldschool"
    capsLockActive: true,
            ...
            var inputFocusListener = function (e) {
                ...
                if (keyboadType === 'keyboard' || keyboadType === 'all') {
                    ...
                    if (keyboadType === 'all') {
                        ...
                        keysRowElements += '<div class="kioskboard-row kioskboard-row">' + numberKeysContent + '</div>';
                    }
                        ...
                        for (var i = 0; i < eachKeyElm.length; i++) {
                            ...
                            keyElm.addEventListener('click', function (e) {
                                ...
                                input.focus();
																	...
																	if ($("#numero_temporal").val()>0) 
																	{
																		cantidad($("#numero_temporal").val(),3);
																	}
