...
class Producto extends Controller{
    ...
    public function getProductoInfo(){
        ...
        $establProducto = $this->producto_model->getProductoComp($producto);
        ...
        if ($productoResult != NULL){
            ...
            foreach ($productoResult as $i => $val) {
                ...
                $productoPrecio = $this->productoprecio_model->getProductoPrecios($val->PROD_Codigo, $establCodigo);
                ...
                if($establProducto != NULL){
                    foreach($establProducto as $index =>$value){
                        $establSelec[] = array(
                                              "Codigo" => $value->COMPP_Codigo,
                        );
                    }
                }
            }
          /*   var_dump($establSelec);
            exit; */

            $json = array("match" => true, "producto" => $productoInfo, "unidades" => $unidades, "precios" => $precios, "establecimientos" => $establSelec);
        }
        else
