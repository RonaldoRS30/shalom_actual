...
$db['default']['password'] = "";
$db['default']['database'] = "sistemadefactura_distribuidoratriplea";


#$db['default']['username'] = "osafactc2_demoAct";
#$db['default']['password'] = "osafactc2_demoAct";
#$db['default']['database'] = "osafactc2_demoAct";
