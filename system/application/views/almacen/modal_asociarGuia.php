<!-- MODAL CLIENTE-->
    <div id="modal_asociarGuia" class="modal fade" role="dialog" data-backdrop="static">
                    ...
                    <div class="modal-body panel panel-default">
                        ...
                        <div class="row form-group">
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <table class="fuente8 display" id="table-asociarguia">
...
<script type="text/javascript">
    ...
    function buscar_asociarGuia() {
            ...
            $('#table-asociarguia').DataTable({
                ...
                autoWidth: false,
                ajax:{
                        url : '<?=base_url();?>index.php/almacen/guiarem/buscarAsociarGuia/',
                        type: "POST",
                        data: {
                            cliente:cliente,
                            proveedor:proveedor,
