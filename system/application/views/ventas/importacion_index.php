    ...
    <script language="javascript">
        $(document).ready(function () {
            ...
            $('#table-importacion').DataTable({
                ...
                autoWidth: false,
                ajax:{
                        url : '<?=base_url();?>index.php/ventas/importacion/datatable_importacion/<?="$tipo_oper/$tipo_docu";?>',
                        type: "POST",
                        beforeSend: function(){
                            $(".loading-table").show();
                        },
             ...
             $(".btn-sendAnulacion").click(function(){
                ...
                var url = "<?=base_url();?>index.php/ventas/importacion/importacion_eliminar";
                $.ajax({
                    url:url,
                    type:"POST",
                    data:{ importacion: codigo, motivo: motivo},
                    dataType:"json",
                    error:function(data){
                    },
                    beforeSend: function(){
...
<body>
     ...
     <div class="modal fade anular-impor" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                        ...
                        <table class="fuente8 display" id="table-importacion">
                            <thead>
                                <tr class="cabeceraTabla">
                                    ...
                                    <th style="width: 07%" data-orderable="true">SERIE</th>
                                    <th style="width: 07%" data-orderable="true">NUMERO</th>
                                    <th style="width: 07%" data-orderable="true">DUA</th>
                                    <th style="width: 27%" data-orderable="true">PROVEEDOR</th>
                                    <th style="width: 08%" data-orderable="true">MONTO</th>
