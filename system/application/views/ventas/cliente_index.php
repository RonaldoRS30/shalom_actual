...
<div class="container-fluid">
    ...
    <form id="form_busqueda" method="post">
        ...
        <!--OPCION PARA CARGA MASIVA DE CLIENTES A LA DB-->
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        {
            postFormDescarga(base_url+"index.php/ventas/cliente/getFormatoCargaClientes/", {pase: '1'});
        });
        ...
        $(".productoCargaMasiva").click(function(){
            ...
            if (extension !== "xls" && extension !== "xlsx") {
                ...
                return false;
                    ...
                    $.ajax({
                        url: base_url+"index.php/ventas/cliente/insertarClientesMasiva/",
                        type:'POST',
                        data: formData,
                        dataType:'json',
                        contentType: false,
                        ...
                        error: function()
                        {
                            Swal.fire(
                                'Error',
                                'ERROR AL CARGARSE LOS CLIENTES, COMUNIQUESE CON SOPORTE TECNICO .',
                                'error'
                            )
                            $("#modalCargarStock").modal("hide");
                        }
