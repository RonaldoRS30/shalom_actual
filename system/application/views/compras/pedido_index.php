...
<div class="container-fluid">
  ...
  <form id="form_busqueda" method="post">
  	<div class="row fuente8 py-1">
	    ...
	    <div class="col-sm-11 col-md-3">
	      ...
	      <select id="estado" name="estado" class="form-control h-2">
	  ...
	  <div class="row fuente8 py-1">
	    <!-- CLIENTE -->
	      <div class="col-sm-11 col-md-1" <?=($tipo_oper == 'V' || 'V1') ? '' : 'hidden'; ?>>
	      ...
	      <div class="col-sm-11 col-md-3" <?=($tipo_oper == 'V' || 'V1') ? '' : 'hidden'; ?>>
  ...
  <div class="row">
    <div class="col-sm-12 col-md-12 col-lg-12 pall-0">
        ...
        <div class="col-sm-12 col-md-12 col-lg-12 pall-0">
          <div class="acciones">
            <div id="botonBusqueda">
              <ul id="1" class="lista_botones" data-toggle="modal" data-target=".modal-fecha">
                <li id="imprimir">Consolidado</li>
              </ul>
              <ul id="nuevoPedido" class="lista_botones">
                <li id="nuevo">Nuevo Pedido<?=$tOperacion;?></li>
              </ul>
              <ul id="limpiarPedido" class="lista_botones">
                <li id="limpiar">Limpiar</li>
              </ul>
              <ul id="buscarPedido" class="lista_botones">
                <li id="buscar">Buscar</li>
              </ul>
              <ul id="imprimirOcompraFiltro" class="lista_botones" <?=($tipo_oper == 'V1') ? '' : 'hidden';?>>
                <li id="excel">Registros</li>
              </ul>
            </div>
      ...
      <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12 pall-0">
          <table class="fuente8 display" id="tb_pedido">
            ...
            <tr class="cabeceraTabla">
              ...
              <th style="width:10%" data-orderable="false" title="Factura/Bolante/Comprobante">F/B/C</th>
              <th style="width:10%" data-orderable="true">ESTADO</th>
              <?php if ($tipo_oper === "V1") : ?>
                  <th style="width:04%" data-orderable="false">TICKET</th>
              <?php endif; ?>
...
<div class="modal fade modal-fecha" style="top:50%; left:50%; transform:translate(-50%, -50%); width:520px; height: 400px; padding:20px;" id = "ModalFecha" role="dialog" data-backdrop="static">
    <div class="modal-dialog modal-temporal">
        <div class="modal-content">
            <form id="form_ocompra" method="POST">
              <div class="modal-header" style="text-align: center;">
                <h2 class="modal-title">FECHA DE CONSOLIDADO</h2> 
              </div>
              <div class="modal-body panel panel-default">
                <div class="row form-group">
                  <div class="col-sm-10 col-md-10 col-lg-11">
                    ...
                    <input type="datetime-local" id="fechaini" name="fechaini" size="10" maxlength="10" value="<?=$hoy?>T00:00">
                </div>
                <div class="row form-group">
                  <div class="col-sm-10 col-md-10 col-lg-11">
                    <div class="col-sm-10 col-md-10 col-lg-11">
                    ...
                    <input type="datetime-local" id="fechafin" name="fechafin" size="10" maxlength="10" value="<?=$hoy?>T23:59">
                </div>
              </div>
				<div class="modal-footer">
					<button type="button" class="btn btn-success" onclick="generarConsolidado();" accesskey="x">Aceptar</button>
					<button type="button" class="btn btn-danger" onclick="cerrarmodalFecha();">Cerrar</button>
				</div>
            </form>
        </div>
    </div>
  
<div class="modal fade bd-example-modal" style="display:none;" id = "ModalVentas" role="dialog" data-backdrop="static">
    <div class="modal-dialog modal-temporal">
        <div class="modal-content">
            <form id="form_ocompra" method="POST">
                <div class="modal-header" style="text-align: center;">
                    <h2 class="modal-title">GUIA DE REMISIÓN MÚLTIPLE</h2> 
                </div>
                <div class="modal-body panel panel-default">
                    <div class="row form-group">
                      ...
                      <div class="col-sm-10 col-md-10 col-lg-11">
                        <div class="col-sm-10 col-md-10 col-lg-11">
                          ...
                          <table id="product_tbl" class="table table-hover">
                              <tbody id="product_tblbody" class="table-hover">
                              </tbody>
                          </table>
                          <tr></tr>
                          <label>Dirección</label><br>
                          <input type="textbox" id="direccionGuiaMult" name="direccionGuiaMult" class="direccion-input"/>
                        </div>
                      </div>
                  </div>
				<div class="modal-footer">
