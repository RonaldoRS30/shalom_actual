                ...
                <td class="comprobante-data" style="width: 33%;">
                    <div class="border" style="margin: 1px 0px 1px 1px;">
                        <table border="0" cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                <td style="padding-left: 0px;"><br></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td style="padding-left: 0px;"><br></td>
                ...
                <tr>
                    <td style="width: 60%; text-align: left; margin-left: 5px;" class="table-redondo">
                        <table class="texto" border="0" cellpadding="2" cellspacing="1" 
                            ...
                            border-radius: 5px;
                            padding: 4px;">
                             <?php if ($data['motivoNota'] != "") :?> 
                                <tr style="font-size: 9px !important;">
                                    <td style="text-align:right; width:30%;"><b>MOTIVO DE EMISIÓN:</b></td>
                                    <td style="width: 60%;text-transform: uppercase;"><?php echo $data['motivoNota'].' '.$data['motivoN'] ?></td>
                                </tr>
                            <?php endif ?>
                                <tr style="font-size: 9px !important;">
                                    <td style="text-align:right; width:30%;"><b>DOCUMENTO RELACIONADO:</b></td>
                                    <td style="width: 60%;text-transform: uppercase;"><?php echo $data['tdocumento'].' '.$data['referencia'] ?></td>
                                </tr>
            ...
            <table class="table-footer" border="0" cellpadding="3" cellspacing="2.5">
                <tr>
                    <td style="width: 85%; vertical-align: top; padding: 5px;" class="table-redondo">
                        <p>
                            Representación impresa de PDF NOTA DE CREDITO ELECTRONICA, para ver el documento 
